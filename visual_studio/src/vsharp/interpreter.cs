...
namespace VSharp
{
    ...
    public class Interpreter 
    {
        ...
        public object? EvaluateExpression(Expression node, Variables variables)
        {
            return node switch
            {
                IdentifierNode identifierNode => EvaluateLoadVar(identifierNode, variables),
        ...
        object EvaluateBinaryOperation(BinaryOperationNode binaryOpNode, Variables variables)
        {
            ...
            if (left is string leftString && right is string rightString)
            {
                return binaryOpNode.Operator switch
                {
                    ...
                    _ => throw Error(binaryOpNode, $"Unsupported operator for strings: {binaryOpNode.Operator}"),
                };
            }
            ...
            if (left is string || right is string)
            {
                ...
                throw Error(binaryOpNode, $"Unsupported operator for mixed types involving strings: {binaryOpNode.Operator}");
            }
            ...
            if (left is int leftInt && right is int rightInt)
            {
                return binaryOpNode.Operator switch
                {
                    ...
                    _ => throw Error(binaryOpNode, $"Unsupported operator: {binaryOpNode.Operator}"),
                };
            }
            ...
            else if (left is int intLeft && right is double doubleRight)
            {
                return binaryOpNode.Operator switch
                {
                    ...
                    "-" => intLeft - doubleRight,
                    "*" => intLeft * doubleRight,
                    "/" => doubleRight != 0 ? intLeft / doubleRight : throw new DivideByZeroException(),
                    _ => throw Error(binaryOpNode, $"Unsupported operator: {binaryOpNode.Operator}"),
                };
            }
            ...
            {
                throw Error(binaryOpNode, "Type mismatch in binary operation.");
            }
        }
